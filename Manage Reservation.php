...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['edit_reservation'])) {
    ...
    $stmt = $conn->prepare("UPDATE reservations SET customer_id=?, table_id=?, room_id=?, reservation_date=?, reservation_time=?, number_of_guests=?, special_requests=?, status=? WHERE reservation_id=?");
...
<body>
    ...
    <div class="Manage">
        <h2 class="Manage">Manage Reservation</h2>
    </div>
